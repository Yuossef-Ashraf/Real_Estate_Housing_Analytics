"""
Production Machine Learning Pipeline for Real Estate Housing Market Analytics & Price Prediction.
...
def train_and_evaluate(csv_path: str = "Housing.csv"):
    ...
    is_class = "regression" == "classification"
...
def main():
    parser = argparse.ArgumentParser(description="Real Estate Housing Market Analytics & Price Prediction CLI")
    parser.add_argument("--data", type=str, default="Housing.csv", help="Path to CSV dataset")
